...
namespace Zork
{
    class Program
    {
        ...
        private static void InitializeRoomDescriptions()
        {
            ...
            Rooms[0, 1].Description = "You are facing the north side of a white house. There is no door here, and all windows are barred.";
            Rooms[0, 2].Description = "You are in a clearing, with a forest surrounding you on the west and south.";

            Rooms[1, 0].Description = "This is a forest, with trees in all diresctions around you.";
            Rooms[1, 1].Description = "This is an open field west of a white house, with a boarded front door.";
            Rooms[1, 2].Description = "You are behind the white house. In one corner of the house there is a window which is slightly ajar.";
